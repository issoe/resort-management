<?php
    ...
    if (isset($_POST['name']) && isset($_POST['area']) && isset($_POST['guests']) && isset($_POST['other']))
    {
		...
		{
			echo "<center><h3>New room type created successfully!<br/>Click here to <a href='roomtype.php'> see it.</a></h3></center>";
		} 
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li  class="active"><a href="add.php">Add a room type</a></li>
